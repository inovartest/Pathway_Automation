...
Then Rise a full Cancelation Request with first Market User 2149
...
Then check the "Approved" status a Cancelation Request with first RPM User 2149
...
Then check the "Approved" status a Cancelation Request with first NOC User 2149
...
Then Request send to FCC of full cancelation process with  First Legal User 2149
...
Then Rise a Cancelation Request with second Market User 2150
...
Then check the "Rejected" status a Cancelation Request with second RPM User 2150
...
Then Rise a Cancelation Request with Third Market User 2151
...
Then check the "Approved" status a Cancelation Request with Third RPM User 2151
...
Then check the "Rejected" status a Cancelation Request with Third NOC User 2151
...
Then Rise a Cancelation Request with fourth Market User 2152
...
Then check the "Approved" status a Cancelation Request with fourth RPM User 2152
...
Then check the "Approved" status a Cancelation Request with fourth NOC User 2152
...
Then Rise a full Cancelation Request with  fifth RPM User 2153
...
Then check the "Approved" status a full Cancelation Request with  fifth NOC User 2153
...
Then Request send to FCC of full Cancelation Request with  fifth Legal User 2153
...
Then Rise a full Cancelation Request with  sixth RPM User 2154
...
Then check the "Rejcted" status a full Cancelation Request with  sixth NOC User 2154
...
Then Rise a full Cancelation Request with  Seventh RPM User 2155
...
Then check the "Approved" status a full Cancelation Request with  seventh NOC User 2155
