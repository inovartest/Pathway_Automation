...
Then Rise a full Cancelation Request with first Market User 2187
...
Then check the "Approved" status a Cancelation Request with first RPM User 2187
...
Then check the "Approved" status a Cancelation Request with first NOC User 2187
...
Then Request send to FCC of full cancelation process with  First Legal User 2187
...
Then Rise a Cancelation Request with second Market User 2188
...
Then check the "Rejected" status a Cancelation Request with second RPM User 2188
...
Then Rise a Cancelation Request with Third Market User 2189
...
Then check the "Approved" status a Cancelation Request with Third RPM User 2189
...
Then check the "Rejected" status a Cancelation Request with Third NOC User 2189
...
Then Rise a Cancelation Request with fourth Market User 2190
...
Then check the "Approved" status a Cancelation Request with fourth RPM User 2190
...
Then check the "Approved" status a Cancelation Request with fourth NOC User 2190
...
Then Rise a full Cancelation Request with  fifth RPM User 2191
...
Then check the "Approved" status a full Cancelation Request with  fifth NOC User 2191
...
Then Request send to FCC of full Cancelation Request with  fifth Legal User 2191
...
Then Rise a full Cancelation Request with  sixth RPM User 2192
...
Then check the "Rejcted" status a full Cancelation Request with  sixth NOC User 2192
...
Then Rise a full Cancelation Request with  Seventh RPM User 2193
...
Then check the "Approved" status a full Cancelation Request with  seventh NOC User 2193
