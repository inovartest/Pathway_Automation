...
Given enter url application into "chrome" for full cancelation flow
When first Market User login with valid creditinals for full cancelation process
Then Rise a full Cancelation Request with first Market User 1609
...
Then check the "Approved" status a Cancelation Request with first RPM User 1609
...
Then check the "Approved" status a Cancelation Request with first NOC User 1609
...
Then Request send to FCC of full cancelation process with  First Legal User 1609
...
Then Rise a Cancelation Request with second Market User 1610
...
Then check the "Rejected" status a Cancelation Request with second RPM User 1610
...
Then Rise a Cancelation Request with Third Market User 1602
...
Then check the "Approved" status a Cancelation Request with Third RPM User 1602
...
Then check the "Rejected" status a Cancelation Request with Third NOC User 1602
...
Then Rise a Cancelation Request with fourth Market User 1603
...
Then check the "Approved" status a Cancelation Request with fourth RPM User 1603
...
Then check the "Approved" status a Cancelation Request with fourth NOC User 1603
...
Then Rise a full Cancelation Request with  fifth RPM User 1604 
...
Then check the "Approved" status a full Cancelation Request with  fifth NOC User 1604
...
Then Request send to FCC of full Cancelation Request with  fifth Legal User 1604
...
Then Rise a full Cancelation Request with  sixth RPM User 1605 
...
Then check the "Rejcted" status a full Cancelation Request with  sixth NOC User 1605
...
Then Rise a full Cancelation Request with  Seventh RPM User 1606 
...
Then check the "Approved" status a full Cancelation Request with  seventh NOC User 1606
