...
Then Rise a full Cancelation Request with first Market User 2107
...
Then check the "Approved" status a Cancelation Request with first RPM User 2107
...
Then check the "Approved" status a Cancelation Request with first NOC User 2107
...
Then Request send to FCC of full cancelation process with  First Legal User 2107
...
Then Rise a Cancelation Request with second Market User 2108
...
Then check the "Rejected" status a Cancelation Request with second RPM User 2108
...
Then Rise a Cancelation Request with Third Market User 2109
...
Then check the "Approved" status a Cancelation Request with Third RPM User 2109
...
Then check the "Rejected" status a Cancelation Request with Third NOC User 2109
...
Then Rise a Cancelation Request with fourth Market User 2110
...
Then check the "Approved" status a Cancelation Request with fourth RPM User 2110
...
Then check the "Approved" status a Cancelation Request with fourth NOC User 2110
...
Then Rise a full Cancelation Request with  fifth RPM User 2111
...
Then check the "Approved" status a full Cancelation Request with  fifth NOC User 2111
...
Then Request send to FCC of full Cancelation Request with  fifth Legal User 2111
...
Then Rise a full Cancelation Request with  sixth RPM User 2112
...
Then check the "Rejcted" status a full Cancelation Request with  sixth NOC User 2112
...
Then Rise a full Cancelation Request with  Seventh RPM User 2113
...
Then check the "Approved" status a full Cancelation Request with  seventh NOC User 2113
