...
Then Rise a full Cancelation Request with first Market User 1643
...
Then check the "Approved" status a Cancelation Request with first RPM User 1643
...
Then check the "Approved" status a Cancelation Request with first NOC User 1643
...
Then Request send to FCC of full cancelation process with  First Legal User 1643
...
Then Rise a Cancelation Request with second Market User 1644
...
Then check the "Rejected" status a Cancelation Request with second RPM User 1644
...
Then Rise a Cancelation Request with Third Market User 1645
...
Then check the "Approved" status a Cancelation Request with Third RPM User 1645
...
Then check the "Rejected" status a Cancelation Request with Third NOC User 1645
...
Then Rise a Cancelation Request with fourth Market User 1639
...
Then check the "Approved" status a Cancelation Request with fourth RPM User 1639
...
Then check the "Approved" status a Cancelation Request with fourth NOC User 1639
...
Then Rise a full Cancelation Request with  fifth RPM User 1640 
...
Then check the "Approved" status a full Cancelation Request with  fifth NOC User 1640
...
Then Request send to FCC of full Cancelation Request with  fifth Legal User 1640
...
Then Rise a full Cancelation Request with  sixth RPM User 1641
...
Then check the "Rejcted" status a full Cancelation Request with  sixth NOC User 1641
...
Then Rise a full Cancelation Request with  Seventh RPM User 1642
...
Then check the "Approved" status a full Cancelation Request with  seventh NOC User 1642
