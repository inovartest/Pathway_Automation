...
Given enter url application into "chrome" for Partial cancelation flow
When first Market User login with valid creditinals for Partial cancelation process
Then Rise a Partial Cancelation Request with first Market User 2328
...
Then check the "Approved" status a  Partial Cancelation Request with first RPM User 2328
...
Then check the "Approved" status a Partial Cancelation Request with first NOC User 2328
...
Then Request send to FCC of Partial cancelation process with  First Legal User 2328
...
Then Rise a Partial Cancelation Request with second Market User 2329
...
Then check the "Rejected" status a Partial Cancelation Request with second RPM User 2329
...
Then Rise a Partial Cancelation Request with Third Market User 2330
...
Then check the "Approved" status a Partial Cancelation Request with Third RPM User 2330
...
Then check the "Rejected" status a Partial Cancelation Request with Third NOC User 2330
...
Then Rise a Partial Cancelation Request with fourth Market User 2331
...
Then check the "Approved" status a Partial Cancelation Request with fourth RPM User 2331
...
Then check the "Approved" status a  Partial Cancelation Request with fourth NOC User 2331
...
Then Rise a Partial Cancelation Request with  fifth RPM User 2332
...
Then check the "Approved" status a Partial Cancelation Request with  fifth NOC User 2332
...
Then Request send to FCC of Partial Cancelation Request with  fifth Legal User 2332
...
Then Rise a Partial Cancelation Request with  sixth RPM User 2333
...
Then check the "Rejcted" status a Partial Cancelation Request with  sixth NOC User 2333
...
Then Rise a Partial Cancelation Request with  Seventh RPM User 2334
...
Then check the "Approved" status a Partial Cancelation Request with  seventh NOC User 2334
