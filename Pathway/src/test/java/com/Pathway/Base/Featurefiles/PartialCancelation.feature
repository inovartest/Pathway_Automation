...
Then Rise a Partial Cancelation Request with first Market User 2307
...
Then check the "Approved" status a  Partial Cancelation Request with first RPM User 2307
...
Then check the "Approved" status a Partial Cancelation Request with first NOC User 2307
...
Then Request send to FCC of Partial cancelation process with  First Legal User 2307
...
Then Rise a Partial Cancelation Request with second Market User 2308
...
Then check the "Rejected" status a Partial Cancelation Request with second RPM User 2308
...
Then Rise a Partial Cancelation Request with Third Market User 2302
...
Then check the "Approved" status a Partial Cancelation Request with Third RPM User 2302
...
Then check the "Rejected" status a Partial Cancelation Request with Third NOC User 2302
...
Then Rise a Partial Cancelation Request with fourth Market User 2303
...
Then check the "Approved" status a Partial Cancelation Request with fourth RPM User 2303
...
Then check the "Approved" status a  Partial Cancelation Request with fourth NOC User 2303
...
Then Rise a Partial Cancelation Request with  fifth RPM User 2304
...
Then check the "Approved" status a Partial Cancelation Request with  fifth NOC User 2304
...
Then Request send to FCC of Partial Cancelation Request with  fifth Legal User 2304
...
Then Rise a Partial Cancelation Request with  sixth RPM User 2305
...
Then check the "Rejcted" status a Partial Cancelation Request with  sixth NOC User 2305
...
Then Rise a Partial Cancelation Request with  Seventh RPM User 2306
...
Then check the "Approved" status a Partial Cancelation Request with  seventh NOC User 2306
