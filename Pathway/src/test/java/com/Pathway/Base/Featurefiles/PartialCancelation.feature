...
Given enter url application into "chrome" for Partial cancelation flow with "local"
When first Market User login with valid creditinals for Partial cancelation process with "local" 
Then Rise a Partial Cancelation Request with first Market User 2342
...
Then check the "Approved" status a  Partial Cancelation Request with first RPM User 2342
...
Then check the "Approved" status a Partial Cancelation Request with first NOC User 2342
...
Then Request send to FCC of Partial cancelation process with  First Legal User 2342
...
Then Rise a Partial Cancelation Request with second Market User 2343
...
Then check the "Rejected" status a Partial Cancelation Request with second RPM User 2343
...
Then Rise a Partial Cancelation Request with Third Market User 2344
...
Then check the "Approved" status a Partial Cancelation Request with Third RPM User 2344
...
Then check the "Rejected" status a Partial Cancelation Request with Third NOC User 2344
...
Then Rise a Partial Cancelation Request with fourth Market User 2345
...
Then check the "Approved" status a Partial Cancelation Request with fourth RPM User 2345
...
Then check the "Approved" status a  Partial Cancelation Request with fourth NOC User 2345
...
Then Rise a Partial Cancelation Request with  fifth RPM User 2346
...
Then check the "Approved" status a Partial Cancelation Request with  fifth NOC User 2346
...
Then Request send to FCC of Partial Cancelation Request with  fifth Legal User 2346
...
Then Rise a Partial Cancelation Request with  sixth RPM User 2347
...
Then check the "Rejcted" status a Partial Cancelation Request with  sixth NOC User 2347
...
Then Rise a Partial Cancelation Request with  Seventh RPM User 2348
...
Then check the "Approved" status a Partial Cancelation Request with  seventh NOC User 2348
