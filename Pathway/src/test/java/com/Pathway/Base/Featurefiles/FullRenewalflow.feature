...
Then Rise a Renewal Request with  first RPM User 2203
...
Then check the "Approved" status a Renewal Request with  first NOC User 2203
...
Then Request send to FCC of Renewal Request with  first Legal User 2203
...
Then Rise a Renewal Request with  second RPM User 2204
...
Then check the "Rejected" status a Renewal Request with  second NOC User 2204
...
Then Rise a Renewal Request with  third RPM User 2205
...
Then check the "Approved" status a Renewal Request with  third NOC User 2205
