...
Given enter url application into "chrome" for Renewal flow with "local"
When first RPM User login with valid creditinals for Renewal process with "stage"
Then Rise a Renewal Request with  first RPM User 2237
...
Then check the "Approved" status a Renewal Request with  first NOC User 2237
...
Then Request send to FCC of Renewal Request with  first Legal User 2237
...
Then Rise a Renewal Request with  second RPM User 2238
...
Then check the "Rejected" status a Renewal Request with  second NOC User 2238
...
Then Rise a Renewal Request with  third RPM User 2239
...
Then check the "Approved" status a Renewal Request with  third NOC User 2239
