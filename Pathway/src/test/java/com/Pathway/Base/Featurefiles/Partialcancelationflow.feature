...
Given enter url application into "browser" for Partial cancelation flow
When first Market User login with valid creditinals for Partial cancelation process
Then Rise a Partial Cancelation Request with first Market User 456
...
Then check the "Approved" status a  Partial Cancelation Request with first RPM User 456
...
Then check the "Approved" status a Partial Cancelation Request with first NOC User 456
...
Then Request send to FCC of Partial cancelation process with  First Legal User 1024
...
Then Rise a Partial Cancelation Request with second Market User 456
...
Then check the "Rejected" status a Partial Cancelation Request with second RPM User 456
...
Then Rise a Partial Cancelation Request with Third Market User 456
...
Then check the "Approved" status a Partial Cancelation Request with Third RPM User 456
...
Then check the "Rejected" status a Partial Cancelation Request with Third NOC User 456
...
Then Rise a Partial Cancelation Request with fourth Market User 456
...
Then check the "Approved" status a Partial Cancelation Request with fourth RPM User 456
...
Then check the "Approved" status a  Partial Cancelation Request with fourth NOC User 456
...
Then Rise a Partial Cancelation Request with  fifth RPM User 1028 
...
Then check the "Approved" status a Partial Cancelation Request with  fifth NOC User 1028
...
Then Request send to FCC of Partial Cancelation Request with  fifth Legal User 1028
...
Then Rise a Partial Cancelation Request with  sixth RPM User 1029 
...
Then check the "Rejcted" status a Partial Cancelation Request with  sixth NOC User 1029
...
Then Rise a Partial Cancelation Request with  Seventh RPM User 1030 
...
Then check the "Approved" status a Partial Cancelation Request with  seventh NOC User 1030
