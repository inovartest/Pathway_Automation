...
Then Rise a Partial Cancelation Request with first Market User 1707
...
Then check the "Approved" status a  Partial Cancelation Request with first RPM User 1707
...
Then check the "Approved" status a Partial Cancelation Request with first NOC User 1707
...
Then Request send to FCC of Partial cancelation process with  First Legal User 1707
...
Then Rise a Partial Cancelation Request with second Market User 1708
...
Then check the "Rejected" status a Partial Cancelation Request with second RPM User 1708
...
Then Rise a Partial Cancelation Request with Third Market User 1709
...
Then check the "Approved" status a Partial Cancelation Request with Third RPM User 1709
...
Then check the "Rejected" status a Partial Cancelation Request with Third NOC User 1709
...
Then Rise a Partial Cancelation Request with fourth Market User 1710
...
Then check the "Approved" status a Partial Cancelation Request with fourth RPM User 1710
...
Then check the "Approved" status a  Partial Cancelation Request with fourth NOC User 1710
...
Then Rise a Partial Cancelation Request with  fifth RPM User 1711 
...
Then check the "Approved" status a Partial Cancelation Request with  fifth NOC User 1711
...
Then Request send to FCC of Partial Cancelation Request with  fifth Legal User 1711
...
Then Rise a Partial Cancelation Request with  sixth RPM User 1712 
...
Then check the "Rejcted" status a Partial Cancelation Request with  sixth NOC User 1712
...
Then Rise a Partial Cancelation Request with  Seventh RPM User 1713 
...
Then check the "Approved" status a Partial Cancelation Request with  seventh NOC User 1713
