...
Then Rise a BuildOutflow Request with  First Market User 1267 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with First RPM User 1267
...
Then check the "Approved" status a BuildOutflow Request with  First NOC User 1267
...
Then Request send to FCC of BuildOutflow Request with  First Legal User 1267
...
Then Rise a BuildOutflow Request with secondMarket User 1261 with "06-18-2020"
...
Then check the "Rejeted" status a BuildOutflow Request with Second RPM User 1261
...
Then Rise a BuildOutflow Request with  Third Market User 1262 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with Third RPM User 1262
...
Then check the "Rejected" status a BuildOutflow Request with  Third NOC User 1262
...
Then Rise a BuildOutflow Request with  fourth Market User 1263 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with fourth RPM User 1263
...
Then check the "Approved" status a BuildOutflow Request with  fourth NOC User 1263
...
Then Rise a BuildOutflow Request with  fifth RPM User 1264 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with  fifth NOC User 1264
...
Then Request send to FCC of BuildOutflow Request with  fifth Legal User 1264
...
Then Rise a BuildOutflow Request with  sixth RPM User 1265 with "06-18-2020"
...
Then check the "Rejcted" status a BuildOutflow Request with  sixth NOC User 1265
...
Then Rise a BuildOutflow Request with  Seventh RPM User 1266 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with  seventh NOC User 1266
