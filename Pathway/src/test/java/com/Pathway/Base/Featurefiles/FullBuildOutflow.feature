...
Then Rise a BuildOutflow Request with  First Market User 721 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with First RPM User 721
...
Then check the "Approved" status a BuildOutflow Request with  First NOC User 721
...
Then Request send to FCC of BuildOutflow Request with  First Legal User 721
...
Then Rise a BuildOutflow Request with secondMarket User 724 with "06-18-2020"
...
Then check the "Rejeted" status a BuildOutflow Request with Second RPM User 724
...
Then Rise a BuildOutflow Request with  Third Market User 725 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with Third RPM User 725
...
Then check the "Rejected" status a BuildOutflow Request with  Third NOC User 725
...
Then Rise a BuildOutflow Request with  fourth Market User 726 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with fourth RPM User 726
...
Then check the "Approved" status a BuildOutflow Request with  fourth NOC User 726
...
Then Rise a BuildOutflow Request with  fifth RPM User 727 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with  fifth NOC User 727
...
Then Request send to FCC of BuildOutflow Request with  fifth Legal User 727
...
Then Rise a BuildOutflow Request with  sixth RPM User 716 with "06-18-2020"
...
Then check the "Rejcted" status a BuildOutflow Request with  sixth NOC User 716
...
Then Rise a BuildOutflow Request with  Seventh RPM User 717 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with  seventh NOC User 717
