...
Then Rise a BuildOutflow Request with  First Market User 2507 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with First RPM User 2507
...
Then check the "Approved" status a BuildOutflow Request with  First NOC User 2507
...
Then Request send to FCC of BuildOutflow Request with  First Legal User 2507
...
Then Rise a BuildOutflow Request with secondMarket User 2508 with "06-18-2020"
...
Then check the "Rejeted" status a BuildOutflow Request with Second RPM User 2508
...
Then Rise a BuildOutflow Request with  Third Market User 2509 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with Third RPM User 2509
...
Then check the "Rejected" status a BuildOutflow Request with  Third NOC User 2509
...
Then Rise a BuildOutflow Request with  fourth Market User 2510 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with fourth RPM User 2510
...
Then check the "Approved" status a BuildOutflow Request with  fourth NOC User 2510
...
Then Rise a BuildOutflow Request with  fifth RPM User 2511 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with  fifth NOC User 2511
...
Then Request send to FCC of BuildOutflow Request with  fifth Legal User 2511
...
Then Rise a BuildOutflow Request with  sixth RPM User 2512 with "06-18-2020"
...
Then check the "Rejcted" status a BuildOutflow Request with  sixth NOC User 2512
...
Then Rise a BuildOutflow Request with  Seventh RPM User 2513 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with  seventh NOC User 2513
