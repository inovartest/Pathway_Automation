...
Then Rise a BuildOutflow Request with  First Market User 2016 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with First RPM User 2016
...
Then check the "Approved" status a BuildOutflow Request with  First NOC User 2016
...
Then Request send to FCC of BuildOutflow Request with  First Legal User 2016
...
Then Rise a BuildOutflow Request with secondMarket User 2008 with "06-18-2020"
...
Then check the "Rejeted" status a BuildOutflow Request with Second RPM User 2008
...
Then Rise a BuildOutflow Request with  Third Market User 2009 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with Third RPM User 2009
...
Then check the "Rejected" status a BuildOutflow Request with  Third NOC User 2009
...
Then Rise a BuildOutflow Request with  fourth Market User 2010 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with fourth RPM User 2010
...
Then check the "Approved" status a BuildOutflow Request with  fourth NOC User 2010
...
Then Rise a BuildOutflow Request with  fifth RPM User 2011 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with  fifth NOC User 2011
...
Then Request send to FCC of BuildOutflow Request with  fifth Legal User 2011
...
Then Rise a BuildOutflow Request with  sixth RPM User 2012 with "06-18-2020"
...
Then check the "Rejcted" status a BuildOutflow Request with  sixth NOC User 2012
...
Then Rise a BuildOutflow Request with  Seventh RPM User 2013 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with  seventh NOC User 2013
