...
Given enter url application into "chrome" for full BuildOutflow flow
When  First Market User login with valid creditinals for full BuildOutflow process
Then Rise a BuildOutflow Request with  First Market User 1217 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with First RPM User 1217
...
Then check the "Approved" status a BuildOutflow Request with  First NOC User 1217
...
Then Request send to FCC of BuildOutflow Request with  First Legal User 1217
...
Then Rise a BuildOutflow Request with secondMarket User 1209 with "06-18-2020"
...
Then check the "Rejeted" status a BuildOutflow Request with Second RPM User 1209
...
Then Rise a BuildOutflow Request with  Third Market User 1210 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with Third RPM User 1210
...
Then check the "Rejected" status a BuildOutflow Request with  Third NOC User 1210
...
Then Rise a BuildOutflow Request with  fourth Market User 1211 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with fourth RPM User 1211
...
Then check the "Approved" status a BuildOutflow Request with  fourth NOC User 1211
...
Then Rise a BuildOutflow Request with  fifth RPM User 1212 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with  fifth NOC User 1212
...
Then Request send to FCC of BuildOutflow Request with  fifth Legal User 1213
...
Then Rise a BuildOutflow Request with  sixth RPM User 1213 with "06-18-2020"
...
Then check the "Rejcted" status a BuildOutflow Request with  sixth NOC User 1213
...
Then Rise a BuildOutflow Request with  Seventh RPM User 1214 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with  seventh NOC User 1214
