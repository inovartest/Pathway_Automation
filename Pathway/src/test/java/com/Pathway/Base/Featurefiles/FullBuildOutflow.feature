...
Then Rise a BuildOutflow Request with  First Market User 2801 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with First RPM User 2701
...
Then check the "Approved" status a BuildOutflow Request with  First NOC User 2701
...
Then Request send to FCC of BuildOutflow Request with  First Legal User 2701
...
Then Rise a BuildOutflow Request with secondMarket User 2702 with "06-18-2020"
...
Then check the "Rejeted" status a BuildOutflow Request with Second RPM User 2702
...
Then Rise a BuildOutflow Request with  Third Market User 2703 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with Third RPM User 2703
...
Then check the "Rejected" status a BuildOutflow Request with  Third NOC User 2703
...
Then Rise a BuildOutflow Request with  fourth Market User 2704 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with fourth RPM User 2704
...
Then check the "Approved" status a BuildOutflow Request with  fourth NOC User 2704
