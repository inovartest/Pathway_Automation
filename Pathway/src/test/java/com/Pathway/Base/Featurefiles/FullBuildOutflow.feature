...
Then Rise a BuildOutflow Request with  First Market User 2605 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with First RPM User 2605
...
Then check the "Approved" status a BuildOutflow Request with  First NOC User 2605
...
Then Request send to FCC of BuildOutflow Request with  First Legal User 2605
...
Then Rise a BuildOutflow Request with secondMarket User 2606 with "06-18-2020"
...
Then check the "Rejeted" status a BuildOutflow Request with Second RPM User 2606
...
Then Rise a BuildOutflow Request with  Third Market User 2607 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with Third RPM User 2607
...
Then check the "Rejected" status a BuildOutflow Request with  Third NOC User 2607
...
Then Rise a BuildOutflow Request with  fourth Market User 2608 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with fourth RPM User 2608
...
Then check the "Approved" status a BuildOutflow Request with  fourth NOC User 2608
...
Then Rise a BuildOutflow Request with  fifth RPM User 2598 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with  fifth NOC User 2598
...
Then Request send to FCC of BuildOutflow Request with  fifth Legal User 2598
...
Then Rise a BuildOutflow Request with  sixth RPM User 2599 with "06-18-2020"
...
Then check the "Rejcted" status a BuildOutflow Request with  sixth NOC User 2599
...
Then Rise a BuildOutflow Request with  Seventh RPM User 2600 with "06-18-2020"
...
Then check the "Approved" status a BuildOutflow Request with  seventh NOC User 2600
