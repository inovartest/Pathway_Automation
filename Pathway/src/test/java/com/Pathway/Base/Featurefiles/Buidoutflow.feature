...
Then Rise a BUildOut request with Marketuser 555 with date "06-08-2020"
...
Then RPM user "Approved" BUildOut request signal with 557
...
Then NOC user "Approved" BUildOutrequest Signal with 557
...
Then Request send to FCC with Legal user FOR BUildOutrequest with 557
