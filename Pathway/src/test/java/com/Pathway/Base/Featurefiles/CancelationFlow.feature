...
Then Rise a Cancelation request with Marketuser 254
...
Then RPM user "Approved" Cancelation signal with 254
...
Then RRM user "Approved" Cancelation Signal with 254
...
Then NOC user "Approved" Cancelation signal with 254
...
Then Request send to FCC with Legal user with 254
